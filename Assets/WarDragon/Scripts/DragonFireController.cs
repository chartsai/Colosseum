        ...
        {            
            for( int i=0; i< m_particlesData.Length; ++i )
            {
                if (m_intensity > 0)
                {
                    ...
                    m_particlesData[i].ps.startSpeed = m_particlesData[i].maxSpeed * m_intensity * m_intensity * transform.lossyScale.magnitude ;
                    m_particlesData[i].ps.startSize = m_particlesData[i].maxSize * m_intensity * m_intensity * transform.lossyScale.magnitude;
                }
                else
                {
